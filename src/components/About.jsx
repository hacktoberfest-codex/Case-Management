...
const About1 = () => {
  return (
    <>
      <section id="about" className="pr-20 pl-28 lg:pt-[120px]  lg:pb-[90px] overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
              ...
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="py-3 sm:py-4">
                    <img
                      src="https://us.123rf.com/450wm/luplupme/luplupme2109/luplupme210900224/173892937-justice-by-law-concept-vector-illustration-police-officer-person-character-lead-criminal-man-to.jpg?ver=6"
                      alt=""
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                      src="https://www.app4legal.com/wp-content/uploads/2019/09/decouments1.png"
                      alt=""
                      className="w-full rounded-2xl"
                    />
                  </div>
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-10 my-4">
                    <img
                      src="https://goalmanager.co.uk/goal-manager/media/goalmanager-casemanagers-header01.jpg"
                      alt=""
                      className="w-full rounded-2xl"
                    />
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <div className="mb-8 text-base text-justify text-body-color">
                  <p>
