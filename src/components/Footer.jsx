          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 justify-center text-justify text-body-color">
                New Approach to Case Management: A Solution to the Backlog of Cases in the Indian Judicial System.
                </p>
            ...
            <LinkGroup header="Company" >
              <NavLink link="/#" label="About e-Case Tracker" />
              <NavLink link="/#" label="Contact & Support" />
              <NavLink link="/#" label="Feedback" />
            ...
            <div className="w-full px-4 mt-20 ml-9 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} Legal Legends{" "}
                </p>
              </div>
            </div>
          </div>
...
const LinkGroup = ({ children, header }) => {
  return (
    <>
      <div className="w-full ml-20 px-4 sm:w-1/2 lg:w-2/12">
        <div className="w-full mb-10">
          <h4 className="text-lg font-semibold mb-9 mt-20 text-dark"> {header} </h4>
          <ul>{children}</ul>
        </div>
      </div>
    </>
